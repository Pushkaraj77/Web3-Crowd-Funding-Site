...
const CampaignDetails = () => {
  ...
  const { getDonations, contract, address, donate, connectToWallet } = useStateContext();
    ...
    <div>
      ...
      >
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            <h4
              className="font-epilogue font-semibold text-[18px]
               text-title-text dark:text-white uppercase"
            >
              CREATOR
            </h4>
            ...
            flex-wrap gap-[14px]">
              ...
              justify-center rounded-full bg-light-bg-col dark:bg-[#2c2f32] cursor-pointer">
                <img src={thirdweb} alt="user" className="w-[60%]
                h-[60%] object-contain" />
              </div>
              <div>
                <h4 className="font-epilogue font-semibold
                text-[14px] text-title-text dark:text-white break-all">{state.owner}</h4>
          ...
          <div>
            ...
            <p className="font-epilogue
                font-normal text-[16px] text-[#808191] 
        ...
        <h4
            ...
            dark:bg-[#1c1c24] bg-light-bg-col rounded-[10px]">
              <p className="font-epilogue font-medium
              text-[20px] leading-[30px] text-center
              text-[#808191]">
                Fund the Campaign
              </p>
              <div className="mt-[30px]">
                ...
                font-epilogue text-title-text dark:text-white text-[18px]
                leading-[30px] placeholder:text-[#4b5264]
                rounded-[10px]"
                value={amount}
                onChange={(e) => setAmount(e.target.value)} />

                <div className="my-[20px] p-4 bg-[#ceceee] dark:bg-[#13131a]
                rounded-[10px]">
                  <h4 className="font-epilogue font-semibold
                  text-[14px] leading-[22px] text-title-text dark:text-white">Back it because you believe in it.</h4>
                  <p className="mt-[20px] font-epilogue
                  font-normal leading-[22px] text-[#808191]">Support the project for no reward, just
                ...
                <div>
                  ...
                  handleClick={address ? handleDonate : connectToWallet}
                  />
                </div>
              </div>
            </div>
